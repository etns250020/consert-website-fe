        ...
        <AnimatePresence>
          {isHovered && (
            ...
            >
              ...
              <p className="text-[#ff5f6d] text-xs font-medium">
                {member.role}
              </p>
            </motion.div>
          )}
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          <ScrollReveal direction="up">
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 tracking-tight text-glow">
              Let's{" "}
              <span className="bg-gradient-to-r from-[#ffc371] to-[#ff5f6d] bg-clip-text text-transparent">
                Connect
              </span>
            </h1>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
              We're here to help you create the ultimate musical experience.
      ...
      <section className="relative px-4 pb-10 max-w-7xl mx-auto ">
        <ScrollReveal direction="up" className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4 tracking-tight flex items-center justify-center gap-2 ">
            ...
            <span className="bg-gradient-to-r from-[#805ad5] to-[#4299e1] bg-clip-text text-transparent ml-2">
              Elite Crew
            </span>
          </h2>
        ...
        <Tabs defaultValue="all" className="w-full">
          <div className="flex  mb-4">
            <TabsList className="  p-1">
              ...
              <TabsTrigger value="Management" className="px-4">
                Management
              </TabsTrigger>
              <TabsTrigger value="Production" className="px-4">
                Production
              </TabsTrigger>
              <TabsTrigger value="Technical" className="px-4">
                Technical
              </TabsTrigger>
            </TabsList>
          </div>
            ...
            <TabsContent key={dept} value={dept} className="mt-0 outline-none">
              ...
              >
                <CarouselContent className="-ml-4 md:-ml-8">
                  {crewMembers
                    .filter(
                      (member) => dept === "all" || member.department === dept,
                    )
                    .map((member) => (
                      <CarouselItem
                        key={member.id}
                        className="pl-4 md:pl-8 md:basis-1/2 lg:basis-1/4"
                      >
                                  ...
                                  <CardContent className="p-0 h-full">
                                    <div className="relative h-full overflow-hidden">
                                      ...
                                      <div className="absolute bottom-0 left-0 p-6 w-full">
                                        <p className="text-white text-xl font-bold mb-0">
                                          {member.name}
                                        </p>
                                        <p className="text-[#ff5f6d] font-medium tracking-wide uppercase text-xs">
                                          {member.role}
                                        </p>
                                      </div>
                                    </div>
                              ...
                              <Card className="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] to-[#16213e] border border-white/10 overflow-hidden p-0 [backface-visibility:hidden] [transform:rotateY(180deg)] shadow-2xl">
                                <CardContent className="p-0 h-full flex flex-col items-center justify-center text-center p-6">
                                  ...
                                  <p className="text-gray-500 text-sm mt-4 italic">
                                    "Expert in creating unforgettable
                                    experiences"
                                  </p>
                                </CardContent>
                              </Card>
          ...
          >
            ...
            <div className="mb-4">
              ...
              <p className="mt-2 text-sm text-white/70 leading-relaxed">
                Planning a concert or live event? Share your details and our
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <a
                href="mailto:hello@concert.app"
                className="text-[#4299e1] font-bold hover:underline"
              >
                hello@concert.app
              </a>
            </div>
